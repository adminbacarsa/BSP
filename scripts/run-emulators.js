...
if (jdkHome) {
  ...
  // Heap ampliado: 768m causaba OOM al importar backups grandes (~18k docs)
  env.JAVA_TOOL_OPTIONS = (env.JAVA_TOOL_OPTIONS || '') + ' -Xms256m -Xmx1536m -XX:+UseG1GC';
  logErr('[emulators] JAVA_TOOL_OPTIONS: heap 256m–1536m, G1GC');
} else {
