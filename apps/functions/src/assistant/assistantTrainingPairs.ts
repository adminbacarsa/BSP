...
export const ASSISTANT_TRAINING_PAIRS: AssistantTrainingPair[] = [
  ...
  { id: 136, categoria: 'rrhh', pregunta_usuario: 'cuantos empleados este mes hay en la plantilla', herramienta_sugerida: 'contar_empleados_plantilla_empresa', respuesta_ideal_bullet: 'Primera oración: legajos activos (número). Aclarar que es nómina empresa al día de referencia, no cantidad de celdas con turno en planificación salvo que lo pidan explícito. RRHH solo como segunda línea opcional.' },
