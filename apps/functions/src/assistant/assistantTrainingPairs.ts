...
export const ASSISTANT_TRAINING_PAIRS: AssistantTrainingPair[] = [
  ...
  { id: 6.1, categoria: 'meta_entorno', pregunta_usuario: '¿En qué versión estoy? ¿Es emulador o producción?', herramienta_sugerida: null, respuesta_ideal_bullet: 'Usar bloque ENTORNO Y VERSIÓN del prompt (clientDeploy + Functions emulator/prod): Lab local vs Producción, build hash, proyecto Firebase. No inventar.' },
  ...
  { id: 88, categoria: 'crm', pregunta_usuario: 'Servicios ligados a cliente', herramienta_sugerida: undefined, respuesta_ideal_bullet: 'Remitir a /admin/servicios filtrando mentalmente.' },
  {
    id: 89,
    categoria: 'crm',
    pregunta_usuario: '¿Cuántos clientes activos?',
    herramienta_sugerida: 'contar_clientes_empresa',
    respuesta_ideal_bullet: 'cuenta_clientes_activos en primera oración; mencionar objetivos embebidos si preguntan sedes totales.',
  },
  {
    id: 153,
    categoria: 'crm',
    pregunta_usuario: 'objetivos de CASISA',
    herramienta_sugerida: 'listar_objetivos_cliente',
    respuesta_ideal_bullet: 'Listar nombre_objetivo; si ambigua pedir cliente exacto.',
  },
  ...
  { id: 140, categoria: 'reportes_horas', pregunta_usuario: 'Compará horas M vs N de un empleado el mes', herramienta_sugerida: 'resumen_horas_empleado_periodo', respuesta_ideal_bullet: 'Usar array por_codigo devuelto por la tool; no inventar subtotales.' },
  {
    ...
    pregunta_usuario: 'horas diurnas y nocturnas en mayo / extras / al 100%',
    herramienta_sugerida: 'resumen_horas_liquidacion_empresa_periodo',
    respuesta_ideal_bullet: 'fecha_referencia en mayo; totales diurnas, nocturnas, al_100_ft, al_50, hs_reales; no buscar empleado «horas extras».',
  },
  ...
  { id: 143, categoria: 'rrhh', pregunta_usuario: 'Resumen de turnos y horas de un legajo en abril', herramienta_sugerida: 'resumen_horas_empleado_periodo', respuesta_ideal_bullet: 'Opcional segunda llamada consultar_turnos_empleado si piden detalle por día; primero totales.' },
  {
    id: 152,
    categoria: 'empleado_turnos',
    pregunta_usuario: 'detalle de los turnos (tras horas de Romina Romero en mayo)',
    herramienta_sugerida: 'consultar_turnos_empleado',
    respuesta_ideal_bullet:
      'Seguimiento de hilo: persona y mes del mensaje anterior; buscar_empleados si falta id; consultar_turnos mayo; listar día/código/objetivo/presencia; nunca inconveniente técnico ni soporte IT.',
  },
  ...
  { id: 148, categoria: 'reportes_horas', pregunta_usuario: '¿Los borradores suman horas?', herramienta_sugerida: 'resumen_horas_empleado_periodo', respuesta_ideal_bullet: 'Aclarar en muestra_turnos campo borrador; totales incluyen documentos salvo cancel/novedad — honestidad sobre planificado vs publicado.' },
  {
    ...
    pregunta_usuario: 'sí (tras oferta de resumen SLA vendidas/planificadas/pendientes todos los objetivos mayo)',
    herramienta_sugerida: 'resumen_horas_sla_varios_objetivos',
    respuesta_ideal_bullet:
      'todos_servicios_activos_mes=true, fecha_referencia 2026-05-15; tabla por cliente-objetivo con vendidas, planificadas, pendientes; no remitir solo a módulos sin tool.',
  },
  {
    id: 151,
    categoria: 'servicios_sla',
  ...
  },
  {
    ...
    herramienta_sugerida: 'resumen_horas_sla_varios_objetivos',
    respuesta_ideal_bullet:
      'Una sola tool con textos_objetivo de cada línea del listado; responder vendidas/planificadas/pendiente por sitio; nunca error técnico genérico.',
  },
  {
    id: 157,
    categoria: 'reportes_horas',
    ...
    respuesta_ideal_bullet:
      'umbral_horas=200, fecha_referencia 2026-05-15; listar nombre/legajo/horas planificadas cobertura; no bolsa_200 ni SLA objetivo; no remitir solo a Reportes.',
  },
  {
    id: 158,
    categoria: 'reportes_horas',
    ...
    herramienta_sugerida: 'listado_empleados_horas_planificadas_umbral',
    respuesta_ideal_bullet:
      'Seguimiento del hilo: misma tool y mes; no listado_empleados_empresa genérico de nómina.',
  },
  {
    id: 159,
    categoria: 'servicios_sla',
    ...
    herramienta_sugerida: 'resumen_horas_sla_varios_objetivos',
    respuesta_ideal_bullet:
      'texto_cliente=CASISA; solo contratos de ese cliente; encabezado «solo CASISA»; no Ministerio ni Lotería.',
  },
  {
    id: 160,
    ...
    respuesta_ideal_bullet:
      'fecha=mañana; mismo dato que Planificación/Operaciones; nunca «no hay turnos» sin Firestore.',
  },
  {
    id: 161,
    categoria: 'presencias_dia',
    pregunta_usuario: 'quienes son los 18 (tras resumen ausentes hoy) / quienes son?',
    herramienta_sugerida: 'listado_ausentes_licencias_dia',
    respuesta_ideal_bullet:
      'tipo=ausentes; listar nombres agrupados por sitio; no confundir con francos ni turnos totales.',
  },
  {
    id: 171,
    categoria: 'presencias_dia',
    pregunta_usuario: 'quienes faltaron hoy / quienes estan ausentes',
    herramienta_sugerida: 'listado_ausentes_licencias_dia',
    respuesta_ideal_bullet:
      'tipo=ausentes; isAbsent en Operaciones; nunca listado_franco_ret_dia (F ≠ ausente).',
  },
  {
    id: 172,
    categoria: 'presencias_dia',
    pregunta_usuario: 'quienes estan de licencia hoy / vacaciones enfermedad',
    herramienta_sugerida: 'listado_ausentes_licencias_dia',
    respuesta_ideal_bullet:
      'tipo=licencias; códigos V/L/E/A/PG en turnos + ausencias RRHH; nombres legibles.',
  },
  {
    id: 173,
    categoria: 'listado_turnos',
    pregunta_usuario: 'turnos H. Misericordia hoy / turnos del servicio X hoy',
    herramienta_sugerida: 'listado_turnos_operativos_dia',
    respuesta_ideal_bullet:
      'buscar_objetivos_por_nombre + listado_turnos_operativos_dia; no listado_clientes_empresa.',
  },
  {
    id: 174,
    categoria: 'presencias_dia',
    pregunta_usuario: 'no podes darme ausencias? / listame ausentes',
    herramienta_sugerida: 'listado_ausentes_licencias_dia',
    respuesta_ideal_bullet:
      'Invocar tool antes de decir que no hay datos; tipo según hilo (ausentes vs licencias).',
  },
  {
    id: 162,
    categoria: 'crm',
    ...
    respuesta_ideal_bullet:
      'Listar los 21 nombres alfabéticos; no repetir solo 10; no decir que no hay tool.',
  },
  {
    id: 163,
    categoria: 'crm',
  ...
  },
  {
    ...
    herramienta_sugerida: 'listado_turnos_operativos_dia',
    respuesta_ideal_bullet:
      'fecha=mañana; hora_inicio_cor=07:00; listar sólo esa franja; no volcar todos los objetivos.',
  },
  {
    id: 176,
    categoria: 'listado_turnos',
    ...
    herramienta_sugerida: 'listado_turnos_operativos_dia',
    respuesta_ideal_bullet:
      'fecha=2026-06-10; codigo_turno=M si «turno mañana»; respuesta acotada al filtro.',
  },
  {
    id: 177,
    categoria: 'empleado_turnos',
    ...
    herramienta_sugerida: 'consultar_turnos_empleado',
    respuesta_ideal_bullet:
      'Sólo legajo del usuario logueado; no listado_turnos_operativos_dia de toda la empresa.',
  },
  {
    id: 178,
    categoria: 'presencias_dia',
    ...
    herramienta_sugerida: 'listado_turnos_operativos_dia',
    respuesta_ideal_bullet:
      'buscar_objetivos + solo_estado_presencia=presente; nombres legibles; no sólo el número 6.',
  },
  {
    id: 179,
    categoria: 'presencias_dia',
    ...
    herramienta_sugerida: 'listado_ausentes_licencias_dia',
    respuesta_ideal_bullet:
      'tipo=ausentes; nunca listado_franco_ret_dia; nombres por sitio.',
  },
];
