...
exports.nvrOnboard = (0, https_1.onRequest)({ timeoutSeconds: 30, memory: '256MiB' }, async (req, res) => {
    try {
        ...
        const agentSecret = (0, crypto_1.randomBytes)(32).toString('base64url');
...
//# sourceMappingURL=nvrOnboard.js.map