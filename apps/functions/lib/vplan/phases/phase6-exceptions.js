...
exports.applyVplanAbsenceExceptions = applyVplanAbsenceExceptions;
const ABSENCE_CODE = 'V';
function applyVplanAbsenceExceptions(opts) {
    if (!opts.enabled)
        return { draft: opts.draft, patchedDays: 0 };
    const byKey = new Map();
...
//# sourceMappingURL=phase6-exceptions.js.map