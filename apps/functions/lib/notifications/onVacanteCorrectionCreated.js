...
exports.onVacanteCorrectionCreated = functions
    ...
    const actionTarget = origin === 'VACANTE_CORRECCION'
    ...
    await batch.commit();
    console.log(`[onVacanteCorrectionCreated] ${sysSnap.size} notif ${type} (${origin}) empresa ${empresaId}`);
});
//# sourceMappingURL=onVacanteCorrectionCreated.js.map