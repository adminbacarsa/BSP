...
`.trim();
exports.ADMIN_MODULE_ROUTE_HINTS = {
...
const MODULE_OPS = {
    ...
    REPORTS: REPORTS_OPS,
    ANALYSIS: 'Análisis (/admin/analisis): métricas y vistas agregadas; probá período/objetivos visibles cuando no cuadren totales.',
    CONFIG: CONFIG_OPS,
    DASHBOARD: 'Dashboard (/admin): atajo a KPIs/atención rápida; la guía puntual viene del módulo al que lleve cada tarjeta o menú lateral.',
...
//# sourceMappingURL=cospKnowledge.js.map