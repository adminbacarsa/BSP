...
exports.ASSISTANT_TRAINING_PAIR_COUNT = exports.ASSISTANT_TRAINING_PAIRS = void 0;
exports.ASSISTANT_TRAINING_PAIRS = [
    ...
    { id: 44, categoria: 'empleado_turnos', pregunta_usuario: 'Busca empleado Pérez', herramienta_sugerida: 'buscar_empleados_por_nombre', respuesta_ideal_bullet: 'texto mínimo 2 chars; listar coincidencias.' },
    {
        ...
        respuesta_ideal_bullet: 'Tratar «hora» como «horas»; buscar_empleados con «romero romina» y resumen_horas_empleado_periodo 2026-05-01 a 2026-05-31 (mes de referencia); totales en primera oración; sin mensaje genérico de soporte IT.',
    },
    ...
    { id: 143, categoria: 'rrhh', pregunta_usuario: 'Resumen de turnos y horas de un legajo en abril', herramienta_sugerida: 'resumen_horas_empleado_periodo', respuesta_ideal_bullet: 'Opcional segunda llamada consultar_turnos_empleado si piden detalle por día; primero totales.' },
    {
        ...
        respuesta_ideal_bullet: 'Seguimiento de hilo: persona y mes del mensaje anterior; buscar_empleados si falta id; consultar_turnos mayo; listar día/código/objetivo/presencia; nunca inconveniente técnico ni soporte IT.',
    },
    ...
    { id: 148, categoria: 'reportes_horas', pregunta_usuario: '¿Los borradores suman horas?', herramienta_sugerida: 'resumen_horas_empleado_periodo', respuesta_ideal_bullet: 'Aclarar en muestra_turnos campo borrador; totales incluyen documentos salvo cancel/novedad — honestidad sobre planificado vs publicado.' },
    {
        ...
        respuesta_ideal_bullet: 'todos_servicios_activos_mes=true, fecha_referencia 2026-05-15; tabla por cliente-objetivo con vendidas, planificadas, pendientes; no remitir solo a módulos sin tool.',
    },
    {
        id: 151,
        categoria: 'servicios_sla',
        ...
        respuesta_ideal_bullet: 'Seguimiento de hilo: usar texto_objetivo del sitio citado y fecha_referencia en junio; responder vendidas, planificadas y pendientes; no pedir más contexto si el asistente acaba de listar el contrato.',
    },
    {
        id: 152,
    ...
    },
    {
        ...
        respuesta_ideal_bullet: 'tipo=ausentes; listar nombres agrupados por sitio; no confundir con francos ni turnos totales.',
    },
    {
        id: 171,
        categoria: 'presencias_dia',
        ...
        herramienta_sugerida: 'listado_ausentes_licencias_dia',
        respuesta_ideal_bullet: 'tipo=ausentes; isAbsent en Operaciones; nunca listado_franco_ret_dia (F ≠ ausente).',
    },
    {
        id: 172,
        categoria: 'presencias_dia',
        ...
        herramienta_sugerida: 'listado_ausentes_licencias_dia',
        respuesta_ideal_bullet: 'tipo=licencias; códigos V/L/E/A/PG en turnos + ausencias RRHH; nombres legibles.',
    },
    {
        id: 173,
        categoria: 'listado_turnos',
        ...
        herramienta_sugerida: 'listado_turnos_operativos_dia',
        respuesta_ideal_bullet: 'buscar_objetivos_por_nombre + listado_turnos_operativos_dia; no listado_clientes_empresa.',
    },
    {
        id: 174,
        categoria: 'presencias_dia',
        ...
        herramienta_sugerida: 'listado_ausentes_licencias_dia',
        respuesta_ideal_bullet: 'Invocar tool antes de decir que no hay datos; tipo según hilo (ausentes vs licencias).',
    },
    {
        id: 162,
        categoria: 'crm',
    ...
    },
    {
        ...
        respuesta_ideal_bullet: 'X completos vs Y incompletos; listar incompletos con CUIT/contacto/objetivos faltantes; pasos en Clientes y Objetivos.',
    },
    {
        id: 165,
        categoria: 'crm',
        ...
        herramienta_sugerida: 'listado_clientes_empresa',
        respuesta_ideal_bullet: 'Seguimiento vago; listado_clientes_empresa con los 21 nombres; no decir que no hay tool.',
    },
    {
        id: 166,
        categoria: 'rrhh',
        ...
        respuesta_ideal_bullet: 'Totales con/sin turno en el mes; listar nombres; orientar a Planificación para cargar grilla.',
    },
    {
        id: 167,
        categoria: 'planificacion_ui',
        ...
        respuesta_ideal_bullet: 'Pasos numerados: Planificación y Turnos → Cliente → Objetivo → mes → grilla → Publicar cronograma.',
    },
    {
        id: 168,
        categoria: 'servicios_sla',
        ...
        herramienta_sugerida: 'resumen_horas_sla_varios_objetivos',
        respuesta_ideal_bullet: 'Horas vendidas SLA del contrato (no liquidación ni fichadas). todos_servicios_activos_mes o resumen_horas_objetivo_sla_periodo; vendidas, planificadas, pendientes.',
    },
    {
        id: 169,
        categoria: 'servicios_sla',
        ...
        herramienta_sugerida: 'resumen_horas_objetivo_sla_periodo',
        respuesta_ideal_bullet: 'Primera cifra: horas_vendidas_sla_mes; no usar resumen_horas_liquidacion_empresa_periodo.',
    },
    {
        id: 170,
        categoria: 'servicios_sla',
