...
import { OpsSalaControls } from '../../src/components/OpsSalaControls';
...
export default function OperacionScreen() {
  ...
  if (!staffProfile || !canAccessMode(staffProfile, 'operacion')) {
    ...
    >
      <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.cardBorder }]}>
        ...
        <Text style={[styles.body, { color: palette.onSurfaceMuted }]}>
          El monitor de operaciones en el celular llega en la Fase 1. Mientras tanto podés tomar el
          mando o sumarte como copiloto de la sala.
        </Text>
      </View>
      <OpsSalaControls />
    </ScrollView>
