        ...
        const rowsWithData = filteredRawShifts
            ...
            .map((s:any) => {
                ...
                return {
                    ...
                    isEarlyStartRow: plannedWindow.isEarlyDisplay,
                    isExtendedRow: plannedWindow.isExtDisplay,
            ...
            <PageShell>
                ...
                {activeTab === 'SERVICIOS' && (() => {
                    ...
                    enPeriodoRaw.forEach((s: any) => {
                        ...
                        const sPosCount = (s.positions || []).length;
                        const pPosCount = prev ? (prev.positions || []).length : 0;
                        if (!prev || sDate > pDate || (sDate === pDate && sPosCount > pPosCount)) {
                            dedupeMap.set(key, s);
                        }
                    });
