...
export default function PlanificacionPage() {
    ...
    const applyAutoScheduleV2 = async () => {
        ...
        try {
            ...
            // Si hay slots que solo podrían cubrirse superando las 200h → aviso sin bloquear
            // El wizard no interrumpe; los slots quedan sin cubrir y se muestran en el reporte.
            if (gen.capOverflowSlots.length > 0) {
                ...
                toast.warning(
                    `${overSlots.length} slot(s) sin cobertura: ${affectedNames.join(', ')} ya alcanza las 200h. Autorizá manualmente si es necesario.`,
                    { duration: 10000 }
                );
            }
