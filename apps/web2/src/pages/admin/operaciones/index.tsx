...
/** @deprecated No montar: usar CoverageSessionManager (protocolo CCT). Se conserva por convocatorias/permuta legacy. */
...
export default function OperacionesPage() {
    ...
    /** Puente call-sites legacy (setCoverageData) → protocolo CCT. */
