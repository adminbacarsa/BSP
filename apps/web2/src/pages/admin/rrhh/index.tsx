    ...
    <DashboardLayout>
        ...
        <div className="max-w-full mx-auto space-y-4 animate-in fade-in h-[calc(100vh-100px)] flex flex-col print:hidden">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-1.5 items-center relative">
                        ...
                        <div className="relative">
                            ...
                            {showRRHHAlerts && (
                                <div className="absolute right-0 top-10 z-50 w-80 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 animate-in slide-in-from-top-2">
            ...
            {activeTab === 'legajos' && view === 'list' && (
                <div className="flex-1 flex gap-6 overflow-hidden relative">
                    ...
                    <div className="w-[340px] bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden shrink-0">
                        ...
                        {selectedEmp ? (
                            <div className="h-full flex flex-col animate-in fade-in">
                                ...
                                <div className="p-5 border-b dark:border-slate-700 bg-gradient-to-r from-slate-50 to-indigo-50/30 dark:from-slate-900 dark:to-indigo-900/10">
                                    <div className="flex justify-between items-start">
                                        <div className="flex gap-4 items-start">
                                            <div className="w-16 h-16 rounded-2xl bg-indigo-600 flex items-center justify-center text-2xl font-black text-white shadow-lg shadow-indigo-500/30 shrink-0">
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-4">
                                    {empStats ? (
                                        <div className="space-y-3">
                                            ...
                                            <div className={`rounded-2xl shadow-lg relative overflow-hidden text-white ${empStats.isOverLimit ? 'bg-gradient-to-br from-rose-700 to-rose-900' : 'bg-gradient-to-br from-slate-800 to-slate-900'}`}>
                                            ...
                                            {selectedEmp.startDate && (() => {
                                              ...
                                              return (
                                                <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/10 border border-amber-100 dark:border-amber-800 rounded-2xl px-4 py-3 flex items-center gap-3">
                                ...
                                <div className="p-4 border-t dark:border-slate-700 bg-white dark:bg-slate-800">
                                    <button onClick={openEditFromDetail} className="w-full py-3.5 bg-slate-900 dark:bg-white dark:text-slate-900 text-white rounded-xl font-black uppercase text-sm hover:scale-[1.02] transition-transform shadow-xl flex items-center justify-center gap-2">
                            ...
                            <div className="h-full overflow-y-auto custom-scrollbar p-5 space-y-4 animate-in fade-in">
                              ...
                              <div className="grid grid-cols-3 gap-3">
                                ...
                                {/* % Activos */}
                                <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-4 flex flex-col justify-between min-h-[90px]">
                                  <div className="flex items-center justify-between">
                                ...
                                {/* Ausentismo */}
                                <div className={`rounded-2xl p-4 flex flex-col justify-between min-h-[90px] border ${globalHRStats.ausentismoPct >= 10 ? 'bg-rose-50 dark:bg-rose-900/20 border-rose-200 dark:border-rose-800' : 'bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-700'}`}>
                                  <div className="flex items-center justify-between">
        ...
        {showAbsenceModal && createPortal(
            <div className="fixed inset-0 z-[200] bg-black/70 flex items-center justify-center p-4" onClick={e => e.target === e.currentTarget && setShowAbsenceModal(false)}>
                <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl w-full max-w-lg shadow-2xl">
                        ...
                        <div className="relative">
                            ...
                            {absenceForm.employeeId ? (
                                ...
                                <div className="relative">
                                    ...
                                    />
                                    {empDropOpen && (
                                        <div className="absolute z-10 top-full left-0 right-0 mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl shadow-xl max-h-48 overflow-y-auto custom-scrollbar">
                                            {employees
