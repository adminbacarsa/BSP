...
import {
  Search, Edit2, Trash2, FileCheck, ChevronLeft, ChevronRight, Calendar,
} from 'lucide-react';
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
            {filteredAbsences.length === 0 ? (
              ...
              const rowBg = selectedAbsenceIds.has(a.id!)
                ...
                : a.type === 'No Presentación' && a.status === 'Confirmada'
                  ...
                  : a.status === 'Injustificada'
                    ...
                    : a.status === 'Justificada'
                      ...
                      : '';
              return (
                <tr key={a.id} className={`hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors ${rowBg}`}>
                  {canAdjust && (
                  ...
                  <td className="px-3 py-2 text-center">{renderAbsenceStatusCell(a)}</td>
