    ...
    <div className="space-y-6 animate-in fade-in">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
              Seguimiento de guía completada por usuario
            </p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm">
          <p className="text-[11px] uppercase font-black text-slate-500">Requeridos</p>
          <p className="text-2xl font-black text-slate-800 dark:text-white">{stats.required}</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm">
          <p className="text-[11px] uppercase font-black text-slate-500">No iniciados</p>
          <p className="text-2xl font-black text-slate-800 dark:text-white">{stats.notStarted}</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-x-auto">
        <table className="w-full text-left text-sm min-w-[940px]">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
            {rows.map((u) => {
              ...
              const track = guide?.track || 'OPERATIONS';
            ...
            {!rows.length && !loading && (
              <tr>
                <td colSpan={7} className="p-8 text-center text-sm text-slate-500 font-medium">
